...
function removeVH(options) {
  ...
  if (
    ...
    return console.log(chalk.red.bold("No virtual host with that domain exists."));
  }
}
...
function alreadyExists() {
  console.log(chalk.red.bold(`A virtual host with that domain already exists.\n`));
